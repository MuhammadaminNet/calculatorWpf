...
namespace WpfCalculatorApp
{
    internal class RequaredMethods
    {
        ...
        public void NumberBtnClick(object element)
        {
            ...
            if (_mainWindow.tmpSaver.Length >= 11)
                _mainWindow.MainInput2.Text = _mainWindow.tmpSaver.Substring(_mainWindow.tmpSaver.Length - 11);

            else _mainWindow.MainInput2.Text = _mainWindow.tmpSaver;
        }
        ...
        public void Clear()
        {
            if (_mainWindow.tmpSaver != "0")
            {
                ...
                else if (_mainWindow.tmpSaver[_mainWindow.tmpSaver.Length - 1] == ' ' && _mainWindow.tmpSaver[_mainWindow.tmpSaver.Length - 3] == ' ')
